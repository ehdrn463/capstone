...
### 1. 수행결과
   ...
   **나. 최종결과물 주요특징 및 설명**
      ...
      1) 주관적 정신진단 검사(SCL) - 정신질환 증상(PANSS)<br>   
         ...
         라) 주관적 정신진단 검사(SCL)의 변수 간에는 전부 양의 상관관계를 보였다. 신체반응, 강박증, 우울증, 불안감, 적대감, 공포불안, 편집증, 대인기피증, 정신분열 증상이 같이 증가하는 경향이 있었다.<br>
      2) 주관적 정신진단 검사(SCL) - 조현병 중증도 평가(CGI)<br>
